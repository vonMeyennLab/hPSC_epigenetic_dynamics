...
subtitle: "DNMT, TET, IDH, PcG, and TrxG family gene expression"
...
combined_gene_list <- c(PcG_TrxG_gene_list, DNMT_TET_IDH_genes)
...
svg(filename = "output/figures/revision/ht_DNMT_TET_IDH.svg", width = 3.5, height = 4.5)
