...
counts_vs_density_by_pluripotency_data <- 
  ...
  filter(seqtype %in% c("H3K27me3", "H3K4me3")) %>% 
...
svg(filename = "output/figures/04_epigenetics_promoters_expression/promoter_expression_regression_1.svg", width = 2.5, height = 7.5)
global_rsq_plot
dev.off()
