...
LB1_rep1 <-
rtracklayer::import("data/results/public_data/Shah_2023/macs/SRR16765006_GSM5669226_embryonic_stem_cells_LB1_ChIP-seq_rep_1_Homo_sapiens_ChIP-Seq_GRCh38_bt2.sorted_summits.bed", format = "bed")

seqlevelsStyle(LB1_rep1) <- "Ensembl"

LB1_rep1 <- LB1_rep1[seqnames(LB1_rep1) %in% "X"]

load("output/database/LOLA/LOLACore/hg38/ucsc_features/ucsc_features.RData")
...
furrr::future_map(list(
  ...
  "Input"                      = bigwig_input[["INPUT_R1.mLb.clN.bigWig"]]
     ...
     ~ normalizeToMatrix(signal       = .x %>% .[seqnames(.) %in% "X"], 
                         target       = LB1_rep1, 
                         value_column = "score", 
                         mean_mode    = "absolute",
                         extend       = 5000,
...
map2(names(.),
  ~ EnrichedHeatmap(.x, 
                    ...
                    use_raster           = T,
                    raster_by_magick     = T,
                    row_split            = factor(rep(c("HNES1 d0", "cR-H9 d0", "HNES1 d10", "cR-H9 d10", "cR-H9 d20X", "cR-H9 d20E", "H9 Primed", "Input"), each = 134098), levels = c("HNES1 d0", "cR-H9 d0", "HNES1 d10", "cR-H9 d10", "cR-H9 d20X", "cR-H9 d20E", "H9 Primed", "Input")),
...
ht_list <- 
draw(
Heatmap(matrix = factor(rep(c("HNES1 d0", "cR-H9 d0", "HNES1 d10", "cR-H9 d10", "cR-H9 d20X", "cR-H9 d20E", "H9 Primed", "Input"), each = 134098), levels = c("HNES1 d0", "cR-H9 d0", "HNES1 d10", "cR-H9 d10", "cR-H9 d20X", "cR-H9 d20E", "H9 Primed", "Input")), 
