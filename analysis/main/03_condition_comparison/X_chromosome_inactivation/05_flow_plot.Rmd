...
map2(flow_plot_data_filtered,
    ...
    function(x, y){
                  map(x %>% named_group_split(cell),
                      ...
                      scale_fill_manual(values = c("H3K9me3.Low_H3K27me3.Low"   = "lightgray",
                                                   "H3K9me3.High_H3K27me3.High" = brewer.pal(n = 11, name = "RdBu")[2],
                                                   "H3K9me3.Low_H3K27me3.High"  = brewer.pal(n = 11, name = "BrBG")[3],
                                                   "H3K9me3.High_H3K27me3.Low"  = brewer.pal(n = 11, name = "BrBG")[9])) +
...
userSets1 <-
map(list(  
"d20E_to_H9_H3K27me3_high_to_H3K9m3_high"                  = c("H3K9me3.Low_H3K27me3.High", "H3K9me3.High_H3K27me3.Low"),
"d20E_to_H9_H3K9me3_H3K27me3_high_to_H3K9m3_H3K27me3_high" = c("H3K9me3.High_H3K27me3.High", "H3K9me3.High_H3K27me3.High"),
"d20E_to_H9_H3K9me3_H3K27me3_high_to_H3K9m3_high"          = c("H3K9me3.High_H3K27me3.High", "H3K9me3.High_H3K27me3.Low"),
"d20E_to_H9_H3K9me3_high_to_H3K9m3_high"                   = c("H3K9me3.High_H3K27me3.Low", "H3K9me3.High_H3K27me3.Low"),
"d20E_to_H9_H3K27me3_high_to_Low"                          = c("H3K9me3.Low_H3K27me3.High", "H3K9me3.Low_H3K27me3.Low"),
"d20E_to_H9_H3K9me3_H3K27me3_high_to_Low"                  = c("H3K9me3.High_H3K27me3.High", "H3K9me3.Low_H3K27me3.Low")),
 ~ flow_plot_data_filtered$`X chromosome` %>% 
  select(index, group, window_type) %>% 
  unique %>% spread(group, window_type) %>% 
  filter(`cR-H9-EOS d20E` == .x[[1]]) %>%
  filter(`H9-EOS` == .x[[2]]) %>% 
...
LOLAcustom_results <- runLOLA(userSets, universeSets, RegionDB_custom, cores = 20, direction = "enrichment")

seqlevelsStyle(userSets) <- "UCSC"
seqlevelsStyle(universeSets) <- "UCSC"
LOLACore_results <- runLOLA(userSets, universeSets, RegionDB_LOLACore, cores = 20, direction = "enrichment")
...
ComplexHeatmap::Heatmap(matrix            = enrichment_data_pvalue_1, 
                        ...
                        cell_fun          = function(j, i, x, y, width, height, fill) {
                          grid.circle(x   = x, 
                                      y   = y, 
                                      r   = log(enrichment_data_pvalue_1[i, j])/150,
...
ComplexHeatmap::Heatmap(matrix           = enrichment_data_pvalue_2, 
                        ...
                        cell_fun         = function(j, i, x, y, width, height, fill) {
                          grid.circle(x  = x, 
                                      y  = y, 
                                      r  = log(enrichment_data_pvalue_2[i, j])/100,
...
# Saving density plot
svg(filename = "output/figures/03_condition_comparison/XChrom_density_plot.svg", width = 6, height = 5)
#pdf(file = "output/figures/03_condition_comparison/XChrom_density_plot.pdf", width = 6, height = 5)
density_plot
dev.off()

# Saving flow plot
svg(filename = "output/figures/03_condition_comparison/XChrom_flow_plot.svg", width = 12, height = 9)
#pdf(file = "output/figures/03_condition_comparison/XChrom_flow_plot.pdf", width = 12, height = 9)
flow_plot
dev.off()

# Saving enrichment plots
svg(filename = "output/figures/03_condition_comparison/XChrom_enrich_plot_1.svg", width = 9, height = 4.5)
enrichment_ht_1
dev.off()

svg(filename = "output/figures/03_condition_comparison/XChrom_enrich_plot_2.svg", width = 6, height = 4)
enrichment_ht_2
dev.off()
